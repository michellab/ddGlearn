...
def build_reactions(perturbations_all_paths, mcs_neighbours):
    ...
    # for the perturbation pair, pick the ligand with lowest weight to query for MCS:
        ...
        similarities = [AllChem.DataStructs.FingerprintSimilarity(query_member, target_fp[0], metric=DataStructs.DiceSimilarity) for target_fp in all_members_FPs]
...
reactions = build_reactions(perturbations_all_paths, mcs_neighbours=3) 
